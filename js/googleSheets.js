...
function getAuth() {
  ...
  // See the matching comment in api/_lib/firebaseAdmin.js — normalizes
  // escaped newlines that can get mangled when this JSON is pasted into a
  // platform's environment variable field.
